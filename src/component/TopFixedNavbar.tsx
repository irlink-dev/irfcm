...
export default function TopFixedNavbar() {
    ...
    function handleDropdown() {
        // console.log('handleDropdown. prevState: ', dropdownOpened);
                        ...
                        <ul className="flex flex-col mt-4 font-medium md:flex-row md:space-x-8 md:mt-0">
                            ...
                            <li>
                                ...
                                <div id="mega-menu-icons-dropdown"
                                     className={dropdownOpened ? globalStyle.topFixedNavbar.DROPDOWN_MENU : 'hidden'}>
                                    <div className="p-4 pb-0 text-gray-900 md:pb-4 dark:text-white">
                                        <ul className="space-y-4" aria-labelledby="mega-menu-icons-dropdown-button">
                                            <li>
                                                <a href="#"
                                                   className={globalStyle.topFixedNavbar.SITE}>
                                                    <span className="sr-only">About us</span>
                                                    <svg
                                                        className={globalStyle.topFixedNavbar.SVG}
