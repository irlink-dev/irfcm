...
export default function TopFixedNavbar() {
    ...
    function handleDropdown() {
        if (!Constant.ENABLE_DROPDOWN_HOVER) {
            ...
            <div className="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
                ...
                <div id="mega-menu-icons"
                    ...
                    <ul className="flex flex-col mt-4 font-medium md:flex-row md:space-x-8 md:mt-0">
                        ...
                        {/*    <a className="block py-2 pl-3 pr-4 text-blue-600 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-blue-500 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700"*/}
                        ...
                        <li>
                            ...
                            {/* TODO dropdown 클릭 시가 아닌, hover 시에 표시되도록 변경. */}
                            <div id="mega-menu-icons-dropdown"
                                 onMouseEnter={openDropdown}            // 메뉴 위에 마우스를 올리면 메뉴 표시.
                                 onMouseLeave={closeDropdown}           // 메뉴 밖으로 마우스가 나가면 메뉴 숨김.
                                 className={dropdownOpened ? GlobalStyle.NAV_MENU : 'hidden'}>
                                <div className="p-4 pb-0 text-gray-900 md:pb-4 dark:text-white">
                                    <ul className="space-y-4" aria-labelledby="mega-menu-icons-dropdown-button">
                                        <li>
                                            <a href="#"
                                               className={GlobalStyle.NAV_ITEM}>
                                                <span className="sr-only">About us</span>
                                                <svg
                                                    className={GlobalStyle.SVG}
                        ...
                        {/*<li>*/}
                        {/*    <a href="#"*/}
                        {/*       className="block py-2 pl-3 pr-4 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-blue-500 md:dark:hover:bg-transparent dark:border-gray-700">Team</a>*/}
                        {/*</li>*/}
                    </ul>
                </div>
            </div>
